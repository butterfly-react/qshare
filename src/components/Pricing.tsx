...
const pricingList: PricingProps[] = [

	{
		...
		benefitList: ["4 Team members", "2 GB Gallery", "100 products", "Up to 4 templates", "Community support", "Cancel any time"],
		href: "/api/auth/login",
	...
	},
	{
		...
		popular: 1,
		price: 559,
		description: "Best for established teams requiring advanced features.",
		buttonText: "Buy Now",
	...
	},
	{
		...
		buttonText: "Buy Now",
		benefitList: ["4 Team members", "8 GB Gallery", "Up to 10 templates", "Priority support", "Cancel any time"],
		href: "/api/auth/login",
		billing: "/year",
